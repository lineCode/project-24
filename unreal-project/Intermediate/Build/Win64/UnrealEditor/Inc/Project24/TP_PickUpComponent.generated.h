...
class AProject24Character;
class UPrimitiveComponent;
class AActor;
struct FHitResult;
#ifdef PROJECT24_TP_PickUpComponent_generated_h
...
static inline void FOnPickUp_DelegateWrapper(const FMulticastScriptDelegate& OnPickUp, AProject24Character* PickUpCharacter) \
{ \
	_Script_Project24_eventOnPickUp_Parms Parms; \
...
public: \
	DECLARE_CLASS(UTP_PickUpComponent, USphereComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Project24"), NO_API) \
