...
template<> JSONLIBRARY_API UScriptStruct* StaticStruct<FJsonLibraryValue>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_JsonLibrary_Source_JsonLibrary_Public_JsonLibraryValue_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_JsonLibrary_Source_JsonLibrary_Public_JsonLibraryValue_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_JsonLibrary_Source_JsonLibrary_Public_JsonLibraryValue_h_4120027810(TEXT("/Script/JsonLibrary"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_JsonLibrary_Source_JsonLibrary_Public_JsonLibraryValue_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_JsonLibrary_Source_JsonLibrary_Public_JsonLibraryValue_h_Statics::ScriptStructInfo),
		nullptr, 0);
