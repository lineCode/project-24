...
template<> WEBUI_API UScriptStruct* StaticStruct<FWebInterfaceCallback>()
{
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_WebUI_Source_WebUI_Public_WebInterfaceCallback_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_WebUI_Source_WebUI_Public_WebInterfaceCallback_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_WebUI_Source_WebUI_Public_WebInterfaceCallback_h_3671435733(TEXT("/Script/WebUI"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_WebUI_Source_WebUI_Public_WebInterfaceCallback_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_WebUI_Source_WebUI_Public_WebInterfaceCallback_h_Statics::ScriptStructInfo),
		nullptr, 0);
