...
public:
	...
	static FIntPoint GenerateImageFromRenderTarget( TArray64<FColor>& OutPixels, UTextureRenderTarget2D* RenderTarget );
	static FIntPoint GenerateImageFromTexture( TArray64<FColor>& OutPixels, UTexture2D* Texture );
	static FIntPoint GenerateImageFromMaterial( TArray64<FColor>& OutPixels, UMaterialInterface* Material, int32 Width, int32 Height );
